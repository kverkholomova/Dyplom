...
class _ChatState extends State<Chat> {
  ...
  CollectionReference<Map<String, dynamic>> chats = FirebaseFirestore.instance.collection("chats");
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index){
                return MessageTile(
                  ...
                  sendByMe: Constants.myName == streamSnapshot.data?.docs[index]["sendBy"],
                );
              });
        },
      ),
